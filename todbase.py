...
#
# Dieses Script importiert alle Gesetze und Verordnungen in eine bestehende SQL Datenbank.
# Struktur: Gesetz/Verordnung (Tabellen) - Paragraf/Artikel (Reihen)  - Absatz (Spalten).
#
