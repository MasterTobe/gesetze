...
#
# https://github.com/matejgrahovac/Deutsche-Bundesgesetze-und-Verordnungen
#
# Alle Gesetzestexte aus gesetze-im-internet.de als SQL-Dump und XML sowie
# Crawler Scripte zur aktualisierung.
#
# Dieses Script sammelt alle Infos zu verfügbaren Gesetzen und Verordnungen von
# https://www.gesetze-im-internet.de/aktuell.html, die u.a. für das Script
# files.py benötigt werden. Alles wird im Ordner "Data" als json gespeichert.
#
...
from bs4 import BeautifulSoup as soup # access webpage DOM
